...
export const PlayerBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-md border-t border-sky-100 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-50 sb-safe-bottom">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 pt-3 pb-1 sm:py-4">
        <div className="flex items-center gap-3 sm:gap-4">
          <TrackCover
            instrument={currentTrack.instrument}
            genre={currentTrack.genre}
            className="w-11 h-11 sm:w-12 sm:h-12 rounded-lg shrink-0"
          ...
          <div className="hidden sm:flex flex-col items-center justify-center flex-1 max-w-md">
            <button
              type="button"
              onClick={togglePlay}
        ...
        <div className="sm:hidden flex items-center gap-2 mt-2 pb-1">
          <span className="text-[10px] text-slate-400 tabular-nums w-8">{formatTime(currentTime)}</span>
